...
const styles: Record<string, { bg: string; color: string }> = {
  ...
  FALSE_POSITIVE: { bg: 'rgba(139,92,246,0.15)', color: '#a78bfa' },
  ...
  LOGGING:        { bg: 'rgba(34,197,94,0.15)',   color: '#4ade80' },
  STOPPED:        { bg: 'rgba(239,68,68,0.15)',   color: '#f87171' },
  DISABLED:       { bg: 'rgba(239,68,68,0.15)',   color: '#f87171' },
}

export default function StatusBadge({ status }: Props) {
  const s = styles[status] || { bg: 'rgba(107,114,128,0.15)', color: '#9ca3af' }
  return (
    <span style={{
